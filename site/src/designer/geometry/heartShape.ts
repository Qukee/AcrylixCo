...
export function heartShape(size: number): Shape {
  ...
  shape.bezierCurveTo(1.0 * s, -0.5 * s, 1.05 * s, 0.4 * s, 0.5 * s, 0.6 * s);
  // Right peak across the dimple to the centre top.
  shape.bezierCurveTo(0.25 * s, 0.75 * s, 0.05 * s, 0.55 * s, 0, 0.4 * s);
  // Left side mirror — centre top to left peak.
  shape.bezierCurveTo(-0.05 * s, 0.55 * s, -0.25 * s, 0.75 * s, -0.5 * s, 0.6 * s);
  // Left peak down to the bottom point.
  shape.bezierCurveTo(-1.05 * s, 0.4 * s, -1.0 * s, -0.5 * s, 0, -s);
